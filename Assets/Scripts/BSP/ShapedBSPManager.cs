...
public class ShapedBSPManager : MonoBehaviour
{
    ...
    public static ShapedBSPManager lm;
    ...
    public void RunTimeCheck()
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            bsp.DivideLevel2(bsp.tree.root);
            bsp.MakeLevel();
    ...
    public void RandomCheck()
    {
        ...
        for (int n = 0; n < 100; n++)
        {
            ...
            bsp2.DivideLevel2(bsp2.tree.root);
            bsp.MakeLevel();
            int num = 0;
    ...
    private void Awake()
    {
        ...
        //bsp = new BSP(100, 100, 0.3f, 0.7f, 10, 20);
        //bsp.DivideLevel2(bsp.tree.root);
        //bsp.MakeLevel();
